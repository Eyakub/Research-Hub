...
public class ScienceDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailsView = (TextView) findViewById(R.id.science_item_click_details);
        ...
        //int output = intent.getIntExtra("value", 0);
        String receiveDetails = intent.getStringExtra("value");
        //storing app title
